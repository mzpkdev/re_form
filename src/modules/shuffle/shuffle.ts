 ...
 * {@link ShuffleOptions.seed} makes the whole pipeline deterministic.
 */
 ...
 */
export const shuffleGeometry = (geometry: THREE.BufferGeometry, opts?: ShuffleOptions): THREE.BufferGeometry => {
...
export const shuffleStl = (input: ArrayBuffer, opts?: ShuffleOptions): ArrayBuffer =>
    geometryToBinaryStl(shuffleGeometry(parseStl(input), opts))
